...
void RenderEngine::Update()
{
	...
	{
		if (renderObject->ShouldBeRendered()) {
			float position[3];
...
void RenderEngine::CreateIcosahedronRenderObject(RenderProxy* renderProxy)
{
	RenderObject* renderObject = new IcosahedronRenderObject(renderProxy);
